...
if fecha_inicial and fecha_final:
    ...
    subsets = {
        "LP_Days_1er.xlsx": generar_subset(
            ...
            ["Movil", "Nombre.Contacto", "Name_Family", "Matricula", "next_mtto", "Km_ult_mtto"]
        ),
        ...
        "LP_Km_1er.xlsx": generar_subset(
            ...
            ["Movil", "Nombre.Contacto", "Name_Family", "Matricula", "Km_ult_mtto", "ultimo_desc_mantenimiento", "Km_comercial", "next_mtto"]
        ),
